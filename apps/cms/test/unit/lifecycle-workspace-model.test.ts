...
describe("lifecycle workspace model", () => {
  ...
  it("renders chronological operation timeline entries while ignoring malformed audit data", () => {
    const operation = {
      auditLog: [
        { action: "operation.stage.completed:upload", at: "2026-08-26T09:02:00.000Z", detail: { outcome: "succeeded" } },
        { action: "operation.created", at: "2026-08-26T09:00:00.000Z", actor: { role: "publisher" } },
    ...
    expect(operationTimelineDisplayOf(operation)).toEqual({
      ...
      state: "running",
      timeline: [
        { action: "operation.created", actorRole: "publisher", at: "2026-08-26T09:00:00.000Z", outcome: null, stage: null },
        { action: "operation.stage.started:upload", actorRole: null, at: "2026-08-26T09:01:00.000Z", outcome: null, stage: "upload" },
        { action: "operation.stage.completed:upload", actorRole: null, at: "2026-08-26T09:02:00.000Z", outcome: "succeeded", stage: "upload" },
      ],
    })
  })
  ...
  it("keeps release history site-scoped and offers only prior stable records as rollback candidates", () => {
    const releases: RecordLike[] = [
      { createdAt: "2026-08-26T12:00:00.000Z", manifestSha256: "current", releaseId: "r3", site: 1, state: "current", tenant: 10 },
      { createdAt: "2026-08-25T12:00:00.000Z", manifestSha256: "stable", releaseId: "r2", site: 1, state: "superseded", tenant: 10 },
      { createdAt: "2026-08-24T12:00:00.000Z", manifestSha256: "old", releaseId: "r1", site: 1, state: "rolled_back", tenant: 10 },
      { createdAt: "2026-08-23T12:00:00.000Z", manifestSha256: "unsafe", releaseId: "r0", site: 1, state: "failed", tenant: 10 },
      { createdAt: "2026-08-26T13:00:00.000Z", manifestSha256: "foreign", releaseId: "other", site: 2, state: "current", tenant: 99 },
    ]
