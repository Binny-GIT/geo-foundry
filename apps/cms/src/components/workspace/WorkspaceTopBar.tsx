...
export const WorkspaceTopBar = ({ session }: { readonly session: WorkspaceTopBarSession }) => {
  ...
  return (
    <header className="gf-workspace-topbar sticky top-0 z-30 flex h-14 shrink-0 items-center gap-3 border-b border-slate-200 bg-white/90 px-4 backdrop-blur lg:px-6">
