...
export type AuthenticatedRequest = Readonly<{
  ...
  /** gfa_ 密钥身份的凭据配置（投稿缺省站点、自动成稿）；Cookie 会话为 null。 */
  credential: Readonly<{ autoAdopt: boolean; defaultSiteId: number | null }> | null
