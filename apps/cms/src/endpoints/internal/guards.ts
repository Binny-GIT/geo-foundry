...
const WORKFLOW_STATUS_BY_CODE: Readonly<Record<string, number>> = {
  ...
  EDITION_WORKFLOW_COMPILE_CONFLICT: 409,
  ...
  EDITION_WORKFLOW_PUBLISHER_REQUIRED: 403,
...
const RELEASE_REGISTRY_STATUS_BY_CODE: Readonly<Record<string, number>> = {
  RELEASE_EDITION_NOT_COMPILED: 409,
  RELEASE_EDITION_SITE_MISMATCH: 409,
  RELEASE_IDENTITY_CONFLICT: 409,
  RELEASE_PUBLISH_AUTHORIZATION_INVALID: 403,
