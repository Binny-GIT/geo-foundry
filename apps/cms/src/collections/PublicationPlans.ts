...
export const PublicationPlans = {
  ...
  fields: localizedFields([
    ...
    { name: "operationId", type: "text", index: true, access: { create: () => false, update: () => false } },
    { name: "claimedAt", type: "date", access: { create: () => false, update: () => false } },
    { name: "claimedBy", type: "text", access: { create: () => false, update: () => false } },
    { name: "attempts", type: "number", required: true, defaultValue: 0, access: { create: () => false, update: () => false } },
    ...
    { name: "revision", type: "number", required: true, defaultValue: 0, access: { create: () => false, update: () => false } },
  ]),
